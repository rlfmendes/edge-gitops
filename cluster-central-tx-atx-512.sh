...
export AKDC_ME=akdc
export AKDC_FQDN="central-tx-atx-512.cseretail.com"
export AKDC_DEBUG="false"
export AKDC_DAPR="false"
export AKDC_REPO="retaildevcrews/edge-gitops"
export AKDC_BRANCH="atx-fleet"
export AKDC_CLUSTER="central-tx-atx-512"
export AKDC_ARC_ENABLED="false"
export AKDC_RESOURCE_GROUP="atx-fleet"
